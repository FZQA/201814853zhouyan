...
def get_word_nubmber(list_file):
    for index,f in enumerate(list_file):
...
get_word_nubmber(readfile.list_file)


#write file_word_dict  into file_word_dict.json
file_word_json=json.dumps(file_word_dict)
fw=open('file_word_dict.json','w')
fw.write(file_word_json)
fw.close()
